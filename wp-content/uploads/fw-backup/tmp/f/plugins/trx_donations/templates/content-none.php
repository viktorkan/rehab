...
<article <?php post_class( 'post_item_single post_item_404 post_item_none_archive' ); ?>>
	<div class="post_content">
		...
		<p class="page_description"><?php echo sprintf( wp_kses( __('Can\'t find what you need? Take a moment and do a search or start from <a href="%s">our homepage</a>.', 'trx_donations'), $TRX_DONATIONS_GLOBALS['allowed_tags']), home_url() ); ?></p>
	</div>
</article>
