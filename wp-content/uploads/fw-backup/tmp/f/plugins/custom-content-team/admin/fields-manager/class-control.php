...
class CCT_Fields_Control {
	...
	public function get_attr() {
		...
		$defaults = array( 'name' => "cct_{$this->manager->name}_setting_{$this->setting}" );
	...
	public function template_textarea( $post_id ) { ?>
		...
		<label>
			...
			<textarea <?php $this->attr(); ?>><?php echo str_replace("{cct_break}", "\n", $this->get_value( $post_id )); ?></textarea>
