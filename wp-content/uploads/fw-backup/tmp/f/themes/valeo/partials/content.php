<?php
/**
 * The default template for displaying content inside loop
 *
...
//		        }
        ...
        <div class="post-content">
            ...
            if( valeo_is_blog_view_excerpt() && !is_single() ){
                echo "<p>";
                if(empty($media)) {
                    echo valeo_truncate_words( strip_tags( get_the_content() ), apply_filters( 'excerpt_length', false ) );
                } else {
                    echo valeo_truncate_words( strip_tags( valeo_remove_first_line_media( get_the_content() ) ), apply_filters( 'excerpt_length', false ) );
                }
                echo " ". apply_filters( 'excerpt_more', false ) . "</p>";
            } else {
