...
wp_enqueue_script( 'valeo-fw-shortcode-testimonials-init', get_template_directory_uri() . '/framework-customizations/extensions/shortcodes/shortcodes/testimonials/static/js/testimonials.js', array( 'jquery' ), "all", true );
